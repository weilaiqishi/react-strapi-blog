...
export const source_github = 'https://github.com/weilaiqishi/react-strapi-blog.git';
// GitHub地址
export const githubUrl = 'https://github.com/weilaiqishi';

// 头像
export const cardUrl = 'https://q1.qlogo.cn/g?b=qq&nk=925577835&s=100';
